...
![Modelo](https://github.com/Vitor247/DS-Java-Spring-Professional/blob/3-API-REST-camadas-CRUD-exce%C3%A7%C3%B5es-valida%C3%A7%C3%B5es/desafio/Modelo.png)

Seu projeto deverá fazer um seed de pelo menos 10 clientes com dados SIGNIFICATIVOS (não é parausar dados sem significado como “Nome 1”, “Nome 2”, etc.). Seu projeto deverá tratar as seguintes exceções:
